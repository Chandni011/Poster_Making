...
public class TermsConditionsActivity extends AppCompatActivity {
    ...
    private void fetchTermsCondition() {
        ...
        TermsConditionsActivity.ApiService apiService = retrofit.create(TermsConditionsActivity.ApiService.class);
            ...
            public void onResponse(Call<PrivacyPolicyResponse> call, Response<PrivacyPolicyResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (policyResponse.getStatus() == 1 && policyResponse.getData() != null && !policyResponse.getData().isEmpty()) {
                        ...
                        Toast.makeText(TermsConditionsActivity.this, policyResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(TermsConditionsActivity.this, "Failed to load Privacy Policy", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<PrivacyPolicyResponse> call, Throwable t) {
                Toast.makeText(TermsConditionsActivity.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
