...
public class UpcomingSeeAll_Adapter extends RecyclerView.Adapter<UpcomingSeeAll_Adapter.ViewHolder>{

    private Context context;
    private List<Category> categories;

    public UpcomingSeeAll_Adapter(Context context, List<Category> categories) {
    ...
    @NonNull
    @Override
    public UpcomingSeeAll_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.upcoming_see_all_layout, parent, false);
        return new UpcomingSeeAll_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UpcomingSeeAll_Adapter.ViewHolder holder, int position) {
